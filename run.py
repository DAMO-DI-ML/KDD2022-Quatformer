...
parser.add_argument('--model', type=str, required=True, default='Quatformer',
...
if args.is_training:
    ...
    for ii in range(args.itr):
        ...
        setting = '{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_eb{}_{}_{}'.format(
            args.model_id,
            args.model,
            args.data,
            args.features,
    ...
    print('The average MSE is {}, and the average MAE is {}.'.format(np.mean(MSEs), np.mean(MAEs)))

else:
    ii = 0
    setting = '{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_eb{}_{}_{}'.format(args.model_id,
                                                                                                  args.model,
                                                                                                  args.data,
                                                                                                  args.features,
                                                                                                  args.seq_len,
