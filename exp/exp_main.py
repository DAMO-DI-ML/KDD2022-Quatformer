...
from models import Quatformer, Quatformer_without_Decoup_Attn, Informer, Autoformer, Transformer
...
class Exp_Main(Exp_Basic):
    ...
    def _build_model(self):
        model_dict = {
            'Quatformer': Quatformer,
            'Quatformer_without_Decoup_Attn': Quatformer_without_Decoup_Attn,
